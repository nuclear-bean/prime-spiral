...
public class E01_BasicBlackAndWhite {
    ...
    public static void main(String[] args) throws IOException {
        ...
        PixelData[][] imageData = MatrixTranslator.translate(matrix, BASIC_BLACK_AND_WHITE());
        generateImage(imageData, new File(OutputPathProvider.getOutputPath("simple_black_and_white", matrix.length, ".png", E01_BasicBlackAndWhite.class)));
    }
